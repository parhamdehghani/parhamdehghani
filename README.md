...
| **merchant-sales-forecast** | Production-ready Machine Learning system for forecasting merchant sales revenue and determining cash advance eligibility, built with PySpark and deployed on Google Cloud Run. | PySpark, Docker, FastAPI, Google Cloud Run, PyTest | [Repo](https://github.com/parhamdehghani/merchant-sales-forecast), [API](https://lightspeed-ml-api-655098395937.us-central1.run.app/forecast) |
