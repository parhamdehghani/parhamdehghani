...
| --- | --- | --- | --- |
| **churn-prediction-ai-agent** | To architect, build, and deploy a scalable, end-to-end MLOps churn prediction system and RAG-based agent on Google Cloud, employing the huge WSDM-KKBox dataset. | version-controlled data (DVC), MLflow, Jenkins CI/CD pipeline, Airflow-orchestrated deployment, Google Kubernetes Engine (GKE), RAG, LLM API | [Repo](https://github.com/parhamdehghani/churn-prediction-ai-agent) |
